                    ...
                    <v-card>
                        ...
                        <v-container grid-list-md>
                            <v-layout wrap>
                                ...
                                <v-flex xs12 sm6 md6>
                                    <v-text-field v-model="num_documento" type="number" label="Número Documento">
                                    </v-text-field>
                                </v-flex>
                                <v-flex xs12 sm6 md6>
    ...
    export default {
        ...
        methods: {
            listar(){
                ...
                axios.get('persona/list',configuracion).then(function (response){
